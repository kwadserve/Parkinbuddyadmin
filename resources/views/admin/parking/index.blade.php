            ...
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">         
                <div class="flex w-full sm:w-auto">
                    <div class="w-48 relative text-slate-500">
                        <input type="text" class="form-control w-48 box pr-10" id="parkingSearch" placeholder="Search by Parking Name">
                ...
                <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                    ...
                    <div class="dropdown ml-auto sm:ml-0">
                        <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#header-footer-modal-preview">
                            <button class="dropdown-toggle btn px-2 box" href="#" aria-expanded="false" data-tw-toggle="dropdown">
                                                ...
                                                <div class="preview">
                                                    <!-- BEGIN: Validation Form -->
                                                        ...
                                                        <div class="input-form">
                                                            <label for="validation-form-1" class="form-label w-full flex flex-col sm:flex-row"> Name on Parking <span class="sm:ml-auto mt-1 sm:mt-0 text-xs text-slate-500">Required, at least 8 characters</span> </label>
                                                            <input id="validation-form-1" type="text" name="name" class="form-control" placeholder="Name of Parking" minlength="8" required>
                                                        </div>
