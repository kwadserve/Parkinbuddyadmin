...
<div class="intro-y box px-5 pt-5 mt-5">
    <div class="flex flex-col lg:flex-row border-b border-slate-200/60 dark:border-darkmode-400 pb-5 -mx-5">
        <div class="flex flex-1 px-5 items-center justify-center lg:justify-start">
            ...
            <div class="ml-5">
                <div class="w-24 sm:w-56 truncate sm:whitespace-normal font-medium text-lg">
                    @if($parkingDetails && $parkingDetails->name != null) {{$parkingDetails->name}}
                    @else {{'-'}}
                    @endif
                 </div>
                <div class="truncate sm:whitespace-normal flex items-center">
                    @if($parkingDetails && $parkingDetails->address != null) {{$parkingDetails->address}}
                    @else {{'-'}}
                    @endif
                </div>
        ...
        <div class="mt-6 lg:mt-0 flex-1 px-5 border-l border-r border-slate-200/60 dark:border-darkmode-400 border-t lg:border-t-0 pt-5 lg:pt-0">
            <?php 
            $userDetails =  User::whereIn('id', array($parkingDetails['manager_id'],$parkingDetails['operator_id']))->get();
            // dd($userDetails);
            ?>
            <div class="flex flex-col justify-center items-center lg:items-start mt-4">
                <div class="truncate sm:whitespace-normal flex items-center"> <i data-lucide="map-pin" class="w-4 h-4 mr-2"></i> {{$parkingDetails->city}}, {{$parkingDetails->state}} </div>
                @foreach ($userDetails as $userDetail)
                <div class="truncate sm:whitespace-normal flex items-center mt-3"> <i data-lucide="user" class="w-4 h-4 mr-2"></i> 
    ...
    <ul class="nav nav-link-tabs flex-col sm:flex-row justify-center lg:justify-start text-center" role="tablist" >
        <li id="example-7-tab" class="nav-item" role="presentation">
            <a href="javascript:;" class="nav-link py-4 flex items-center active" data-tw-toggle="pill" data-tw-target="#example-tab-7" type="button" role="tab" aria-controls="example-tab-7"
        ...
        <li id="example-3-tab" class="nav-item" role="presentation">
            <a href="javascript:;" class="nav-link py-4 flex items-center" data-tw-toggle="pill" data-tw-target="#example-tab-3" type="button" role="tab" aria-controls="example-tab-3"
