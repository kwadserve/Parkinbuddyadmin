        ...
        <table class="table table-report -mt-2">
            ...
            @if($userVehicleData && $userVehicleData->count() > 0)
                ...
                <tr class="intro-x">
                    ...
                    <td class="w-40 text-center !py-4 whitespace-nowrap text-primary">{{$userVehicle->number}}</td>
                    ...
                    <td class="text-center"><div class="whitespace-nowrap">{{$userVehicle->address}}</div></td>
                    <td class="text-center"><div class="whitespace-nowrap">{{$userVehicle->pincode}}</div></td>
                    <td class="text-center"><div class="whitespace-nowrap">{{$userVehicle->city}}</div></td>
                    <td class="text-center">
                        <div class="whitespace-nowrap"><?=date_format(date_create($userVehicle->created_at), "h:m:s a")?></div>
                        <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5"><?=date_format(date_create($userVehicle->created_at), "d-m-Y")?></div>
                    </td>
                    <td class="text-center">
                        <div class="whitespace-nowrap"><?=date_format(date_create($userVehicle->updated_at), "h:m:s a")?></div>
                        <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5"><?=date_format(date_create($userVehicle->updated_at), "d-m-Y")?></div>
                    </td> 
                </tr>
                @endforeach
                @else
