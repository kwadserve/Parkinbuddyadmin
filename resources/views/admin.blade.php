...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}"  class="light">
 ...
 <head>
    <meta charset="utf-8">
    <link href="{{ URL::asset('dist/images/favicons/favicon-32x32.png') }}" rel="shortcut icon">
    <link rel="icon" href="{{ URL::asset('dist/images/favicons/favicon.ico') }}" type="image/x-icon">
    <link rel="apple-touch-icon" href="{{ URL::asset('dist/images/favicons/apple-touch-icon.png') }}">
    <link rel="manifest" href="{{ URL::asset('dist/images/favicons/site.webmanifest') }}">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Parkinbuddy Admin">
    <meta name="keywords" content="Parkinbuddy">
    <meta name="author" content="Kwad">
    <title>Dashboard - Parkinbuddy</title>
    <!-- BEGIN: CSS Assets-->
    ...
    <div class="flex mt-[4.7rem] md:mt-0">
        ...
        <nav class="side-nav">
            <a href="" class="intro-x flex items-center pl-5 pt-4">
                <img alt="Parkinbuddy Admin" class="w-6" src="{{ URL::asset('dist/images/pblogo.png') }}">
                <span class="hidden xl:block text-white text-lg ml-3"> Parkinbuddy </span> 
            </a>
